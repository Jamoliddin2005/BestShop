...
const Categories = ({ categoryBig, categoryLoading,
    setCategoryLoading, setCategoryBig, ProductMore }) => {
        ...
        <div className={classes.Categories}>
            <div className={classes.container}>
                <div className={classes.row}>
                    {categoryBig.length ? categoryLoading ?
                        <Loading /> :
                        categoryBig.map((item, index) => (
                            <div key={index} className={classes.product} onClick={() => ProductMore(item._id)}>
